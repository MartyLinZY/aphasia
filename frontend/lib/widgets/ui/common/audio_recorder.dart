...
class Recorder extends StatefulWidget {
  ...
  const Recorder({super.key, this.onStop, required this.encoder,
    this.streamMode = true, this.onStreamModeStop})
  ...
  Future<void> _start() async {
    try {
      if (await _audioRecorder.hasPermission()) {
        ...
        // Record to stream
        await recordStream(_audioRecorder, config, onStop: widget.onStreamModeStop!);
