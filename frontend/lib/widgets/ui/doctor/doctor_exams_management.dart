                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        commonStyles?.onErrorColor?.withOpacity(0.05) ?? Colors.white,
                      ]
                    )
                  ),
        ...
        children: [
          Expanded(
            child: NavigationRail(
              ...
              unselectedIconTheme: IconThemeData(color: Colors.grey.withOpacity(0.8)),
              labelType: constraints.maxWidth >= 800 ? NavigationRailLabelType.none : NavigationRailLabelType.selected,
              destinations: [
    ...
    switch (selectedIndex) {
      ...
      default:
        return Center(
          child: Text(
            '页面未找到',
            style: commonStyles?.titleStyle?.copyWith(color: commonStyles?.errorColor)
          )
        );
    }
  }
